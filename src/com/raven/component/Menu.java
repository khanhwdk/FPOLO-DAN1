...
public class Menu extends javax.swing.JPanel {
    ...
    private void init() {
        ...
        listMenu1.addItem(new Model_Menu("0", " ", Model_Menu.MenuType.EMPTY));
        listMenu1.addItem(new Model_Menu("4", "Sản Phẩm", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("5", "Chi Tiết Sản Phẩm", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("6", "Thông Tin Sản Phẩm", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("0", " ", Model_Menu.MenuType.EMPTY));
